...
* **Sample Call:**
  ...
  ```
  curl -X POST --url http://localhost:8000/api/v1/view_source --data "hash=6c23c2970551be15f32bbab0b5db0c71&mode=ipa&file=helloworld.app/ResourceRules.plist" -H "Authorization:7e2ddf418b291d2e070496524d1b8599c31637f84055c5db632f49f1a613f5f5"
  ```
  ```
  curl -X POST --url http://localhost:8000/api/v1/view_source --data "hash=6c23c2970551be15f32bbab0b5db0c71&mode=ipa&file=classdump.txt" -H "Authorization:87e2ddf418b291d2e070496524d1b8599c31637f84055c5db632f49f1a613f5f5"
  ```
  ```
  curl -X POST --url http://localhost:8000/api/v1/view_source --data "hash=57bb5be0ea44a755ada4a93885c3825e&mode=ios&file=DamnVulnerableIOSApp/View%20Controllers/HomeViewController.m" -H "Authorization:7e2ddf418b291d2e070496524d1b8599c31637f84055c5db632f49f1a613f5f5"
  ```
<hr>
