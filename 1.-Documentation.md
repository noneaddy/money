...
![Mobile Security Framework (MobSF) Running](https://cloud.githubusercontent.com/assets/4301109/21990292/3cff544e-dc34-11e6-9974-ccfcdf4c1c13.png)
...
2. [Dynamic Analysis using a Rooted Android Device (Works for all the apps)](https://github.com/MobSF/Mobile-Security-Framework-MobSF/wiki/1.-Documentation#configuring-dynamic-analyzer-with-rooted-android-devicecustom-vm)
3. [Dynamic Analysis using a custom Android VM (not tested)](https://github.com/MobSF/Mobile-Security-Framework-MobSF/wiki/1.-Documentation#configuring-dynamic-analyzer-with-rooted-android-devicecustom-vm)
...
### Configuring Dynamic Analyzer with Rooted Android Device/Custom VM

* MobSFy the Android Device/Custom VM, Follow the instructions here: [Configure MobSF Dynamic Analysis Environment in your Android Device or VM](https://github.com/MobSF/Mobile-Security-Framework-MobSF/wiki/2.-Configure-MobSF-Dynamic-Analysis-Environment-in-your-Android-Device-or-VM)
...
If you are updating MobSF, In most cases you will have to perform database migrations or you will see errors such as
```
...
[How to Configure Postgres DB](https://github.com/MobSF/Mobile-Security-Framework-MobSF/wiki/Use-Postgres-Database-Instead-of-Sqlite3)
