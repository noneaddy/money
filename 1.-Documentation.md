...
### MonstaApps Application Detail

you can get application information (for android application) from Monsta

* get MonstaApps API KEY from: [here](https://appmonsta.com/dashboard/get_api_key/)

In `MobSF/settings.api`, add your API Key to `MONSTAAPP_KEY`.
