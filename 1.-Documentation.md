...
* If you are using Kali as Host OS and want to run MobSF Dynamic Analysis, read [this](https://github.com/ajinabraham/Mobile-Security-Framework-MobSF/issues/158#issuecomment-224218250)
...
* MobSF Static Analysis available as a [Docker Image](https://hub.docker.com/r/opensecurity/mobsf/) and also comes with [Android Tamer Distribution]() 
