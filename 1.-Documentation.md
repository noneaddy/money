...
### AppMonsta Application Detail

you can get application information (for android application) from AppMonsta

* get AppMonsta API KEY from: [here](https://appmonsta.com/dashboard/get_api_key/)

In `MobSF/settings.py`, add your API Key to `APPMONSTA_KEY`.
