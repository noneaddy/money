...
1. [Dynamic Analysis with MobSF supplied Android VM (Works for most apps)]()
2. [Dynamic Analysis using a Rooted Android Device (Works for all the apps)]()
3. [Dynamic Analysis using a custom Android VM (not tested)]()
