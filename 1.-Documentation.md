...
* If you are using Kali as Host OS and wish to run MobSF Dynamic Analysis, read [this](https://github.com/ajinabraham/Mobile-Security-Framework-MobSF/issues/158#issuecomment-224218250)
...
* MobSF Static Analysis available as a [Docker Image - MobSF v0.9.2](https://hub.docker.com/r/opensecurity/mobsf/) and also comes with [Android Tamer Distribution](https://sourceforge.net/projects/androidtamer/) 
