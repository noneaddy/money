...
4. [Dynamic Analysis using a Rooted Android 4.03 - 4.4 VirtualBox VM (not tested)](https://github.com/MobSF/Mobile-Security-Framework-MobSF/wiki/1.-Documentation/#configuring-dynamic-analyzer-with-rooted-android-403---44-virtualbox-vm)
