...
Use the MobSF docker image from [DockerHub](https://hub.docker.com/r/opensecurity/mobile-security-framework-mobsf/).
(Dynamic analysis mostly need you to configure MobSF in host OS than inside a container.) 
