...
* Run `mobsfy_AVD.py` script and specify the directory that contains the files extracted from `MobSF_ARM_Emulator.zip`. This will automatically populate AVD related settings in `MobSF/settings.py`
