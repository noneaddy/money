...
**NOTE**: If you are configuring MobSF Android VM in VirtualBox for Dynamic Analysis, you must have configured MobSF in the host OS and not inside VM or Docker container.
